...
import './App.css';
import back from './images/nvision.png';
import back1 from './images/product.png';
import back2 from './images/defect iden.png';
import back3 from './images/defects cat.png';
import back4 from './images/pricing.png';
...
function App() {
  ...
  const stepRefs = useRef([useRef(null), useRef(null), useRef(null), useRef(null), useRef(null)]).current;
